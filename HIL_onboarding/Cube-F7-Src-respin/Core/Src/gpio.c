...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOF, LDAC_Pin|GPIO12V_6_Pin|GPIO12V_5_Pin|GPIO12V_4_Pin
  ...
  /*Configure GPIO pins : LDAC_Pin GPIO12V_6_Pin GPIO12V_5_Pin GPIO12V_4_Pin
                           GPIO12V_3_Pin GPIO12V_2_Pin */
  GPIO_InitStruct.Pin = LDAC_Pin|GPIO12V_6_Pin|GPIO12V_5_Pin|GPIO12V_4_Pin
                          |GPIO12V_3_Pin|GPIO12V_2_Pin;
